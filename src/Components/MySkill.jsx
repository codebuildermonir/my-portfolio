...
const MySkill = () => {
      return (
            <div className="bg-[#212428] ">
                 ...
                 <h1 className="text-white md:text-5xl font-semibold " >As a <span className='text-[#FF014F]'>Front End Developer </span>{` I'm good`}<br></br> at using:</h1>
                 </div>

            <div className="max-w-5xl mx-auto grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 justify-center py-20 gap-4" >
            <div className="card md:w-60 md:h-40 justify-center items-center bg-[#212428] hover:bg-[#1C1E22] drop-shadow-2xl shadow-slate-300">
            ...
            <div className="card md:w-60 md:h-40 bg-[#212428] hover:bg-[#1C1E22] drop-shadow-2xl shadow-slate-300">
